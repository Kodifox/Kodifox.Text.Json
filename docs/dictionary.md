...
- `Array`: The value is added as an array to the resulting dictionary using the [`ValueList`](https://github.com/Kodifox/Kodifox.Text.Json/blob/main/Kodifox.Text.Json/ValueList.cs) class.
...
- `Object`: The value is converted into another [`ValueDictionary`](https://github.com/Kodifox/Kodifox.Text.Json/blob/main/Kodifox.Text.Json/ValueDictionary.cs) instance and added to the resulting dictionary.

...
One of the main drivers behind Kodifox.Text.Json was to implement merging functionality for JSON data. That seems to be an increasingly common requirement in applications processing JSON data.
...
All of these steps are supported by extension methods defined in the [`ExtensionMethods`](https://github.com/Kodifox/Kodifox.Text.Json/blob/main/Kodifox.Text.Json/ExtensionMethods.cs) class.
...
1. If both values are [dictionary objects](https://github.com/Kodifox/Kodifox.Text.Json/blob/main/Kodifox.Text.Json/ValueDictionary.cs), they will be merged as dictionary objects and added to the resulting dictionary.
2. If both values are [arrays](https://github.com/Kodifox/Kodifox.Text.Json/blob/main/Kodifox.Text.Json/ValueList.cs), then will be merged as arrays and added to the resulting dictionary.
